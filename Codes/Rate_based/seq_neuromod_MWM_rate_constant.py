...
import psutil
"""
Sequential weight change (SWC) implementation with a constant 5-HT function instead of Delta and rate-based RL.
...
Run as: python seq_neuromod_MWM_rate_constant.py -o <name_job> -e <episodes> -t <trials> -s
...
def main():
    ...
    parser.add_option("-t", "--trials", dest="trials",
      help="Number of trials", metavar="int",default=100)

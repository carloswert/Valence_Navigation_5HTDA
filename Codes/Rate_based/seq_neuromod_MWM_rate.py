...
"""
Sequential weight change (SWC) implementation with a Delta function as 5-HT in a rate-based rule.
...
Run as: python seq_neuromod_MWM_rate.py -o <name_job> -e <episodes> -t <trials> -s
